...
>> Using Bayes' Theorem, the probability that Elvis was an identical twin is 29.4%.  The calculation is as follows:
  A: Probability of identical twin.
  B: Probability of twin (fraternal or identical).

  P(A|B) = [P(B|A) x P(A)]/P(B)
  .294 = [1.0 x (1/300)]/[(1/300 + 1/125)]  
...
Frequentist:
- sampling is infinite; data are repeatable random sample; there is frequency
- decision rules can be sharp; underlying parameters remain constant during repeatable process; parameters fixed

Bayesian:
- unknown quantities are treated probabilistically; data observed from realized sample
- state of the world can always be updated; parameters unknown and described probabilistically; data are fixed  

Source:
Casella, George. "Bayesians and Frequentists." University of Florida.  http://www.stat.ufl.edu/archived/casella/Talks/BayesRefresher.pdf
