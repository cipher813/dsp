...
>> Would like to spend more time with vim, although comfort zone is nano.  
...
>> I use atom, was recommended to me for a previous class and it seems a popular
choice for coders.  Install packages by navigating to Packages/Settings View/
Install Packages.  Useful keyboard shortcuts:
  Ctrl \ close righthand menu
  Ctrl / (un)comment
  Ctrl S Save
